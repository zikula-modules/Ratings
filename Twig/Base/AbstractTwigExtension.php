...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('paustianratingsmodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('paustianratingsmodule_templateSelector', [$this, 'getTemplateSelector'])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('paustianratingsmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('paustianratingsmodule_formattedTitle', [$this, 'getFormattedEntityTitle']),
            new \Twig_SimpleFilter('paustianratingsmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    ...
    /**
     * The paustianratingsmodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The paustianratingsmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
