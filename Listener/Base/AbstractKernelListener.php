...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from ratings app';
     *     $event->getRequest()->attributes->set('PaustianRatingsModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('PaustianRatingsModule_test');`
     *     now `$testMessage` should be: `'Hello from ratings app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('ratings App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
