...
abstract class AbstractUserListener implements EventSubscriberInterface
{
    ...
    public function delete(GenericEvent $event)
    {
        ...
        $logArgs = ['app' => 'PaustianRatingsModule', 'user' => $this->currentUserApi->get('uname'), 'entities' => 'rating systems'];
        ...
        // set last editor to admin (UsersConstant::USER_ID_ADMIN) for all ratings updated by this user
        $repo->updateLastEditor($userId, UsersConstant::USER_ID_ADMIN, $this->translator, $this->logger, $this->currentUserApi);
        // set user id to guest (UsersConstant::USER_ID_ANONYMOUS) for all ratings affected by this user
        $repo->updateUserField('userId', $userId, UsersConstant::USER_ID_ANONYMOUS, $this->translator, $this->logger, $this->currentUserApi);
        
        $logArgs = ['app' => 'PaustianRatingsModule', 'user' => $this->currentUserApi->get('uname'), 'entities' => 'ratings'];
        $this->logger->notice('{app}: User {user} has been deleted, so we deleted/updated corresponding {entities}, too.', $logArgs);
    }
}
