...
abstract class AbstractRatingSystemRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = RatingSystemEntity::class;
     ...
     *                       (optional) (default=false)
     *
     * @return array Retrieved RatingSystemEntity instances
     */
     ...
     *                       (optional) (default=false)
     *
     * @return array List of retrieved ratingSystemEntity instances
     */
     ...
     * @param int $excludeId Identifier of rating systems to exclude (optional)
     *
     * @return bool Result of this check, true if the given rating system does not already exist
     */
