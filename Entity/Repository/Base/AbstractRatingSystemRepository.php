...
namespace Paustian\RatingsModule\Entity\Repository\Base;
 ...
 *
 * This is the base repository class for rating system entities.
 */
abstract class AbstractRatingSystemRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'Paustian\RatingsModule\Entity\RatingSystemEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'scaleDim';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'PaustianRatingsModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'rating systems', 'userid' => $userId];
     ...
     *
     * @return array|ratingSystemEntity Retrieved data array or ratingSystemEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved ratingSystemEntity instances
     */
    public function selectByIdList($idList = [0], $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('ratingSystem', $qb);
        }
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('ratingSystem', $qb);
        }
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('ratingSystem', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numRatingSystems';
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('ratingSystem', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of rating systems to exclude (optional)
     *
     * @return boolean Result of this check, true if the given rating system does not already exist
     */
    ...
    public function genericBaseQuery($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if (true === $slimMode) {
            ...
            $selection = 'tbl.id';
            $selection .= ', tbl.scaleDim';
            $selection .= ', tbl.iconUrl';
            $selection .= ', tbl.iconFa';
            $useJoins = false;
        }
