 ...
 */
abstract class AbstractRatingRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'Paustian\RatingsModule\Entity\RatingEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'moduleName';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'PaustianRatingsModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'ratings', 'userid' => $userId];
    ...
    public function updateUserField($userFieldName, $userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        if (empty($userFieldName) || !in_array($userFieldName, ['userId'])) {
        ...
        $logArgs = ['app' => 'PaustianRatingsModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'ratings', 'field' => $userFieldName, 'userid' => $userId, 'newuserid' => $newUserId];
    ...
    public function deleteByUserField($userFieldName, $userId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'PaustianRatingsModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'ratings', 'field' => $userFieldName, 'userid' => $userId];
     ...
     *
     * @return array|ratingEntity Retrieved data array or ratingEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved ratingEntity instances
     */
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('rating', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of ratings to exclude (optional)
     *
