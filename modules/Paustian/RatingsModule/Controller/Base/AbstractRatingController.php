...
abstract class AbstractRatingController extends AbstractController
{
     ...
     *
     * @param Request $request
     * @param int $id Identifier of treated rating instance
     *
     * @return Response Output
     *
     * @throws AccessDeniedException Thrown if the user doesn't have required permissions
     ...
     * @param int $id Identifier of created rating (used for activating auto completion after closing the modal window)
     *
     * @return Response
     */
    public function handleInlineRedirectAction(
    ...
    )
     {
        ...
        return new PlainResponse(
            $this->get('twig')->render('@PaustianRatingsModule/Rating/inlineRedirectHandler.html.twig', $templateParameters)
        );
    }
