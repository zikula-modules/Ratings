...
abstract class AbstractRatingRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = RatingEntity::class;
    ...
    public function updateUserField(
        ...
        if (empty($userFieldName) || !in_array($userFieldName, ['userId'], true)) {
     ...
     *                       (optional) (default=false)
     *
     * @return array Retrieved RatingEntity instances
     */
     ...
     *                       (optional) (default=false)
     *
     * @return array List of retrieved ratingEntity instances
     */
     ...
     * @param int $excludeId Identifier of ratings to exclude (optional)
     *
     * @return bool Result of this check, true if the given rating does not already exist
     */
