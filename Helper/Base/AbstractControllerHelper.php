...
abstract class AbstractControllerHelper
{
    ...
    public function processViewActionParameters($objectType, SortableColumns $sortableColumns, array $templateParameters = [])
    {
        ...
        $templateParameters['own'] = (bool)$request->query->getInt('own', $this->variableApi->get('PaustianRatingsModule', 'showOnlyOwnEntries', false)) ? 1 : 0;
        ...
        $quickNavForm = $this->formFactory->create('Paustian\RatingsModule\Form\Type\QuickNavigation\\' . ucfirst($objectType) . 'QuickNavType', $templateParameters);
