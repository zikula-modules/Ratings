...
abstract class AbstractRatingSystemController extends AbstractController
{
    ...
    protected function handleSelectedEntriesActionInternal(Request $request, $isAdmin = false)
    {
        ...
        foreach ($items as $itemId) {
            ...
            try {
                ...
                $logger->error('{app}: User {user} tried to execute the {action} workflow action for the {entity} with id {id}, but failed. Error details: {errorMessage}.', ['app' => 'PaustianRatingsModule', 'user' => $userName, 'action' => $action, 'entity' => 'rating system', 'id' => $itemId, 'errorMessage' => $exception->getMessage()]);
            }
            ...
            if ($action == 'delete') {
                ...
                $logger->notice('{app}: User {user} deleted the {entity} with id {id}.', ['app' => 'PaustianRatingsModule', 'user' => $userName, 'entity' => 'rating system', 'id' => $itemId]);
            } else {
                $this->addFlash('status', $this->__('Done! Item updated.'));
                $logger->notice('{app}: User {user} executed the {action} workflow action for the {entity} with id {id}.', ['app' => 'PaustianRatingsModule', 'user' => $userName, 'action' => $action, 'entity' => 'rating system', 'id' => $itemId]);
            }
        }
     ...
     * @param integer $id          Identifier of created rating system (used for activating auto completion after closing the modal window)
     *
    ...
    public function handleInlineRedirectAction($idPrefix, $commandName, $id = 0)
    {
        ...
        return new PlainResponse($this->get('twig')->render('@PaustianRatingsModule/RatingSystem/inlineRedirectHandler.html.twig', $templateParameters));
    }
