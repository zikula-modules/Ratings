    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('objectId', IntegerType::class, [
            ...
            'attr' => [
                'maxlength' => 11,
                'class' => '',
                'title' => $this->__('Enter the object id of the rating.') . ' ' . $this->__('Only digits are allowed.')
            ],
            'required' => true,
            'scale' => 0
        ]);
        ...
        $builder->add('rating', IntegerType::class, [
            ...
            'attr' => [
                'maxlength' => 3,
                'class' => '',
                'title' => $this->__('Enter the rating of the rating.') . ' ' . $this->__('Only digits are allowed.')
            ],
            'required' => true,
            'scale' => 0
        ]);
        ...
        $builder->add('ratingSystem', IntegerType::class, [
            ...
            'attr' => [
                'maxlength' => 11,
                'class' => '',
                'title' => $this->__('Enter the rating system of the rating.') . ' ' . $this->__('Only digits are allowed.')
            ],
            'required' => true,
            'scale' => 0
        ]);
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'Paustian\RatingsModule\Entity\RatingEntity',
