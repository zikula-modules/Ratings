...
/**
 * Rating system quick navigation form type base class.
 */
abstract class AbstractRatingSystemQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * RatingSystemQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('ratingSystem', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    public function addSortingFields(FormBuilderInterface $builder, array $options = [])
    {
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'choices' =>             [
                    $this->__('Scale dim') => 'scaleDim',
                    $this->__('Icon fa') => 'iconFa',
                    $this->__('Icon url') => 'iconUrl',
    ...
    {
        return 'paustianratingsmodule_ratingsystemquicknav';
    }
}
