...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters = [])
    {
        ...
        if ('create' == $this->templateParameters['mode']) {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->requestStack->getCurrentRequest()->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the rating yet as other items are required which must be created before!'));
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'PaustianRatingsModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'rating', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
